...
### Results & Business Recommendation :
  ...
  2. A key driver of no-show rates identified in the analysis is waiting time (Wait Days), defined as the difference between the appointment date and the scheduled date
